...
public class SpellSelector : MonoBehaviour
{
    ...
    public GameObject T2Spell_Lockpick;
    ...
    public void SelectSpell(string spellName)
    {
        ...
        switch (spellName)
        {
            ...
            case "DispelSummons":
                ...
                break;
            case "FishingNet":
                selectedPrefab = T2Spell_FishingRod;
                break;
            case "Freeze":
                selectedPrefab = T2Spell_Freeze;
                break;
            case "Wind":
                selectedPrefab = T2Spell_Wind;
                break;
            case "Boulder":
                selectedPrefab = T2Spell_Boulder;
                break;
            case "Gravity":
                selectedPrefab = T2Spell_Gravity;
                break;
            case "Explosion":
                selectedPrefab = T2Spell_Explosion;
                break;
            case "Thunder":
                selectedPrefab = T2Spell_Thunder;
                break;
            case "Lockpick":
                selectedPrefab = T2Spell_Lockpick;
                break;
            case "VerdantGrowth":
                selectedPrefab = T2Spell_VerdantGrowth;
                break;
            case "DispelOther":
                selectedPrefab = T2Spell_DispelOther;
                break;
            default:
                return;
        }
